...
def atualizar_hoje_I_J(sheet, data_atual):
    ...
    indicadores_I = [
        ...
        ("I9", 91684, "Sao Paulo", []),
        ("I10", 91684, "POA", []),
        ("I11", 91684, "Novas cidades", []),
        ("I12", 93017, "detr_opera", []),
        ("I13", 93017, "maint_fixes", []),
        ("I14", 93017, "maint_issue", []),
        ("I15", 93017, "maint_recurrent", []),
        ("I16", 93017, "total_inspection", []),
        ("I17", 89765, "rec_pend", []),
        ("I18", 89766, "ag_diag", []),
        ("I19", 96394, "pendente_diagnostico", []),
        ("I20", 89761, "total_flag_mec", []),
        ("I21", 89761, "total_flag_fun", []),
        ("I22", 93017, "total_flag_mec", []),
        ("I23", 93017, "total_flag_fun", []),
        ("I24", 89771, "total_recebidos", [parametro_data("data_chegada", data_atual)]),
        # No original, card 89773 era chamado sem parâmetro dentro do processar_atualizacao.
        ("I25", 89773, "diag_mec", []),
        ("I26", 89850, "total_diag", []),
    ...
    indicadores_J = [
        ...
        ("J8", 89761, "detr_preparation", []),
        ("J9", 89761, "detr_prep_sp", []),
        ("J10", 89761, "detr_prep_poa", []),
        ("J11", 89761, "detr_prep_cidades", []),
        ("J12", 89761, "detr_operacoes_sp", []),
        ("J13", 89761, "detr_fixes_sp", []),
        ("J14", 89761, "detr_issue_sp", []),
        ("J15", 89761, "detr_recurrent_sp", []),
        ("J16", 89761, "detr_inspection_sp", []),
        ("J20", 89761, "detr_mec", []),
        ("J21", 89761, "detr_fun", []),
        ("J22", 89761, "detr_mec_sp", []),
        ("J23", 89761, "detr_fun_sp", []),
    ]
...
def atualizar_bloco_principal(sheet, data_filtro, coluna_base, coluna_aux_m=None):
    mapa = [
        ...
        (f"{coluna_base}8", 91686, "total_preparation", "data_backlog"),
        (f"{coluna_base}9", 91686, "prep_sao_paulo", "data_backlog"),
        (f"{coluna_base}10", 91686, "prep_poa", "data_backlog"),
        (f"{coluna_base}11", 91686, "prep_novas_cidades", "data_backlog"),
        (f"{coluna_base}12", 89830, "detr_opera_sp", "data_backlog"),
        (f"{coluna_base}13", 89830, "maint_fixes_sp", "data_backlog"),
        (f"{coluna_base}14", 89830, "maint_issue_sp", "data_backlog"),
        (f"{coluna_base}15", 89830, "maint_recurrent_sp", "data_backlog"),
        (f"{coluna_base}16", 89830, "total_inspection_sp", "data_backlog"),
        (f"{coluna_base}18", 92088, "ag_diag", "data_inicial"),
        (f"{coluna_base}20", 89847, "total_flag_mec", "data_backlog"),
        (f"{coluna_base}21", 89847, "total_flag_fun", "data_backlog"),
        (f"{coluna_base}22", 89847, "total_flag_mec_sp", "data_backlog"),
        (f"{coluna_base}23", 89847, "total_flag_fun_sp", "data_backlog"),
...
def atualizar_detratores(sheet, data_filtro, coluna_destino):
    mapa = [
        ...
        (f"{coluna_destino}8", 89830, "detr_preparation"),
        (f"{coluna_destino}9", 91686, "detr_prep_sp"),
        (f"{coluna_destino}10", 91686, "detr_prep_poa"),
        (f"{coluna_destino}11", 91686, "detr_prep_cidades"),
        (f"{coluna_destino}12", 89830, "detr_operacoes_sp"),
        (f"{coluna_destino}13", 89830, "detr_fixes_sp"),
        (f"{coluna_destino}14", 89830, "detr_issue_sp"),
        (f"{coluna_destino}15", 89830, "detr_recurrent_sp"),
        (f"{coluna_destino}16", 89830, "detr_inspection_sp"),
        (f"{coluna_destino}20", 89847, "detr_mec"),
        (f"{coluna_destino}21", 89847, "detr_fun"),
        (f"{coluna_destino}22", 89847, "detr_mec_sp"),
        (f"{coluna_destino}23", 89847, "detr_fun_sp"),
    ]
